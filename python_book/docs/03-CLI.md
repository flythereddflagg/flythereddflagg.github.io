...
- **Windows 7/8/10**
  ...
  - Select "Windows PowerShell" from the list of options to open it. (A blue box with some text and a prompt should appear that looks something like this: `C:\Users\"YOUR USERNAME"\> `)
- **Apple Mac OS X**
  ...
  - Select the "Terminal" application to open it. (A white box with some text should appear with a prompt that looks something like: `"YOUR COMPUTER'S NAME":~ "YOUR USERNAME"$ `)
- **Linux** 
